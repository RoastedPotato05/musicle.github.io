...
<body style="background-color:#233436">
    <?php 
        ...
        for ($j = 0; $j < 6; $j++) { 
            ...
            if (trim($guess) == trim($answer_string)) {
                echo "<p><div class=\"w3-panel w3-topbar w3-bottombar w3-leftbar w3-rightbar w3-border-green w3-round-large w3-padding-16 w3-center\" style=\"width:500px;margin:0 auto; color: white; background-color: #172224\" class=\"panel panel-default\"><b>$guess</b></div><p>";
            }
            elseif (explode(",", (trim(explode(" -- ", $guess)[1])))[0] == explode(",", trim($answer[1]))[0]) {
    ...
    <form action="musicle_game.php" method="post">
        <b><input type="submit" name="next" value="Next" class="w3-round-large w3-button w3-green w3-padding" style="width:500px;margin:0 auto;display:flex;justify-content:center;"></b></input>
    </form>
